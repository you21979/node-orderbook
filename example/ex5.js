...
getPoloniexDepth("XRP","BTC").then(function(book){ return book.dmap() }).then(function(book){
...
//getBittrexDepth("XRP","BTC").then(function(book){ return book.dmap() }).then(console.log)
